...
String ssid = "Caldera";     // REPLACE mySSID WITH YOUR WIFI SSID
String pass = "Carstensz"; // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
String token = "1300102006:AAFctdLI5k-FWlQvoYOEf2jKmhjO1Jod0L8";   // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
uint8_t led = 16;            // the onboard ESP8266 LED.    
